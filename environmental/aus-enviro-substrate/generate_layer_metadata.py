...
class MetadataGenerator:
    COL_IDX_IN_GUIDE = 2  # index of the collection in the guide.json file
    ...
    def __init__(self):
        ...
        self.destination = "source/aus-enviro-substrate"
    ...
    def _generate_collection(self):
        ...
        This program generates metadata files for environmental substrate collection.
        """
            ...
            "collections": [
                {
                    ...
                    "subjects": [
                        "A suite of variables describing the geological conditions of the land surface in Australia."
                    ]
                }
            ]
        }
    ...
    @staticmethod
    def _collect_parameters(in_dataset):
        parameters = {}
    ...
    def _generate_data(self):
        ...
        for ds in self.datasets:
            ...
            for f in file_names:
                ...
                new_item["bccvl:metadata"]["data_type"] = "continuous"  # substrate is continuous data
